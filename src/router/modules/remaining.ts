...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "essay",
        name: "Essay",
        component: () => import("@/views/post/essay/index.vue"),
        meta: {
          title: () => {
            const configs = getConfig();
            const appName = configs?.APP_NAME;
      ...
      },
      {
        path: "fcircle",
        name: "Fcircle",
        component: () => import("@/views/post/fcircle/index.vue"),
        meta: {
          title: () => {
            const configs = getConfig();
            const appName = configs?.APP_NAME;
  ...
  {
    // Logto回调路由
    path: "/callback/openid/:connector",
    name: "OpenIDCallback",
    component: () => import("@/views/login/oauth-callback.vue"),
    meta: {
      title: () => {
  ...
  {
    // 彩虹聚合登录回调路由
    path: "/callback/rainbow",
    name: "RainbowCallback",
    component: () => import("@/views/login/oauth-callback.vue"),
    meta: {
      title: () => {
        const configs = getConfig();
