 ...
 * @LastEditTime: 2025-09-03 10:35:21
 * @LastEditors: 安知鱼
-->
<template>
  <el-tabs v-model="activeSubTab">
    ...
    <el-tab-pane label="即刻页配置" name="essayPage">
      <el-form :model="model" label-position="top" class="setting-form">
        <EssayPageForm v-model="model.essay" />
      </el-form>
    </el-tab-pane>
    <el-tab-pane label="朋友圈配置" name="momentsPage">
      <el-form :model="model" label-position="top" class="setting-form">
        <MomentsPageForm v-model="model.moments" />
      </el-form>
    </el-tab-pane>
    <el-tab-pane label="第三方登录" name="oauthPage">
      <el-form :model="model" label-position="top" class="setting-form">
        <OAuthPageForm v-model="model.oauth" />
      </el-form>
    </el-tab-pane>
    <el-tab-pane label="SEO配置" name="seoPage">
      <el-form :model="model" label-position="top" class="setting-form">
        <SeoSettingsForm v-model="model.seo" />
      </el-form>
    </el-tab-pane>
  </el-tabs>
</template>
...
import EssayPageForm from "./frontDesk/EssayPageForm/index.vue";
import MomentsPageForm from "./frontDesk/MomentsPageForm/index.vue";
import OAuthPageForm from "./frontDesk/OAuthPageForm/index.vue";
import SeoSettingsForm from "./frontDesk/SeoSettingsForm/index.vue";
