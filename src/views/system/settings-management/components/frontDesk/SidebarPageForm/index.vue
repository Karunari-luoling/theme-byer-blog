...
<template>
  <div>
    ...
    <el-divider content-position="left">天气时钟</el-divider>
    <el-form-item label="启用天气时钟">
      <div style="display: flex; flex-direction: column; gap: 4px">
        <el-switch v-model="model.weatherEnable" />
    ...
    <div v-if="model.weatherEnable" class="weather-config-section">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="应用页面">
            <el-select v-model="model.weatherEnablePage" placeholder="请选择">
              <el-option label="所有页面" value="all" />
              <el-option label="文章页面" value="post" />
            </el-select>
            <div class="form-item-help">选择天气时钟显示的页面范围</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="和风天气 Key">
            <el-input
              v-model="model.weatherQweatherKey"
        ...
        <el-col :span="12">
          <el-form-item label="和风天气 API 域名">
            <el-input
              v-model="model.weatherQweatherAPIHost"
              placeholder="例如: devapi.qweather.com"
              clearable
            />
            <div class="form-item-help">和风天气API域名或自定义域名</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="IP 定位 API Key">
            <el-input
              v-model="model.weatherIPAPIKey"
        ...
        <el-col :span="12">
          <el-form-item label="加载动画 URL">
            <el-input
              v-model="model.weatherLoading"
              placeholder="加载动画图片地址"
              clearable
            />
            <div class="form-item-help">自定义加载动画，建议使用GIF格式</div>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="默认显示固定位置">
        <div style="display: flex; flex-direction: column; gap: 4px">
          <el-switch v-model="model.weatherDefaultRectangle" />
          <div class="form-item-help">
            开启后将一直显示下方设置的固定位置天气，否则将获取访问者的地理位置与天气
          </div>
        </div>
      </el-form-item>

      <el-form-item label="默认/后备位置坐标">
        <el-input
          v-model="model.weatherRectangle"
          placeholder="格式: 经度,纬度 (例: 112.6534116,27.96920845)"
          clearable
        />
        <div class="form-item-help">
          获取访问者位置失败时会显示该位置的天气；<br />
