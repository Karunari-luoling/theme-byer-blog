...
<template>
  ...
  <ComicListEditor
    ...
    @update:comic-list="val => (formData.comic.list = val)"
  />
  ...
  <CareerListEditor
    ...
    @update:career-list="val => (formData.careers.list = val)"
  />
...
.switches-container {
  ...
  margin-bottom: 20px;
  padding: 20px;
  background-color: var(--anzhiyu-secondbg, var(--el-fill-color-lighter));
  border-radius: 8px;
