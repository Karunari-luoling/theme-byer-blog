...
const dialogTitle = computed(() =>
  showExportTab.value ? "文章导入导出（PRO版）" : "文章导入（PRO版）"
);
...
const importOptions = reactive<ImportArticleOptions>({
  ...
  import_paid_content: true,
  import_password_content: true,
  import_full_text_hidden: true
});
          ...
          <div class="import-options">
            <el-form label-width="140px" label-position="left">
              ...
              <el-divider content-position="left">
                <span style="font-size: 13px; color: var(--anzhiyu-main)"
                  >PRO 功能</span
                >
              </el-divider>

              <el-form-item label="导入付费内容">
                <el-switch v-model="importOptions.import_paid_content" />
                <span class="option-tip">是否导入文章的付费内容配置</span>
              </el-form-item>

              <el-form-item label="导入密码保护">
                <el-switch v-model="importOptions.import_password_content" />
                <span class="option-tip">是否导入密码保护块配置</span>
              </el-form-item>

              <el-form-item label="导入全文隐藏">
                <el-switch v-model="importOptions.import_full_text_hidden" />
                <span class="option-tip">是否导入全文隐藏配置</span>
              </el-form-item>
            </el-form>
          </div>
